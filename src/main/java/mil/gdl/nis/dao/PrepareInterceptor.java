...
public class PrepareInterceptor implements Interceptor {
	...
	private String attachLimitQuery(BoundSql boundSql, PageInfo pageInfo,String sqlId) throws Exception{
		...
		sb.append("\n )");
		sb.append("\nWHERE RN > ");
		sb.append((pageInfo.getPageNum() - 1) * pageInfo.getRowPerPage());
		sb.append("\nAND RN <= ");
		sb.append(pageInfo.getPageNum()*pageInfo.getRowPerPage());
	...
	private boolean isNullPageInfo(PageInfo pageInfo) {
		return pageInfo.getPageNum() == null || pageInfo.getRowPerPage() == null;
	}
